...
func TestIEventsDB(t *testing.T) {
...

	{
		...
		bytesAddress, err := hex.DecodeString("NOAHx04bea23efb744dc93b4fda4c20bf4a21c6e195f1"[5:])
		if err != nil {
			t.Fatal(err)
		}
		copy(event.Address[:], bytesAddress)
		hexPubKey, err := hex.DecodeString("NOAHp9e13f2f5468dd782b316444fbd66595e13dba7d7bd3efa1becd50b42045f58c6"[5:])
		if err != nil {
			t.Fatal(err)
		}
	...
	}
	{
		...
		bytesAddress, err := hex.DecodeString("NOAHx18467bbb64a8edf890201d526c35957d82be3d95"[5:])
		if err != nil {
			t.Fatal(err)
		}
		copy(event.Address[:], bytesAddress)
		hexPubKey, err := hex.DecodeString("NOAHp738da41ba6a7b7d69b7294afa158b89c5a1b410cbf0c2443c85c5fe24ad1dd1c"[5:])
		if err != nil {
			t.Fatal(err)
		}
		copy(event.ValidatorPubKey[:], hexPubKey)
